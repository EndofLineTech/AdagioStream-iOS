...
@MainActor
public final class MigrationDiagnostics: ObservableObject {
    public static let shared = MigrationDiagnostics()
    ...
    public func recordRunStart(itemsFound: Int) {
    ...
    public func recordFailed(_ reason: String) {
    ...
    private nonisolated static func loadSnapshot(from defaults: UserDefaults) -> Snapshot {
        Snapshot(
